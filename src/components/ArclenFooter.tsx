...
const FOOTER_LINKS: Record<string, FooterLink[]> = {
  Products: [
    ...
    { name: "Build Platform", href: "/build", badge: "COMING SOON" },
  ],
  Services: [
...
export function ArclenFooter() {
  return (
    <footer className="relative py-16 overflow-hidden">
      {/* Top border with centered orange glow */}
      <div
        className="absolute top-0 left-0 right-0 h-px"
        style={{
          background:
            "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.1) 20%, rgba(232,93,4,0.5) 50%, rgba(255,255,255,0.1) 80%, transparent 100%)",
        }}
      />
      {/* Glow bloom below the line */}
      <div
        className="absolute top-0 left-0 right-0 pointer-events-none"
        style={{
          height: 40,
          background:
            "radial-gradient(ellipse 50% 100% at 50% 0%, rgba(232,93,4,0.08) 0%, transparent 100%)",
        }}
      />

      <div className="relative z-10 max-w-[1200px] mx-auto px-6">
        <div className="grid grid-cols-2 sm:grid-cols-[1.8fr_1fr_1fr_1fr_1fr] gap-8 mb-12">
          {/* Brand column */}
      ...
      {/* Copyright bar */}
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 pt-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
